...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
    ...
    ("PkOfflineFlags", Layout {size: size_of::<PkOfflineFlags>(), alignment: align_of::<PkOfflineFlags>()}),
...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ...
    ("(gint) PK_CLIENT_ERROR_DECLINED_INTERACTION", "10"),
    ...
    ("(guint) PK_OFFLINE_FLAGS_INTERACTIVE", "1"),
    ("(guint) PK_OFFLINE_FLAGS_NONE", "0"),
    ("PK_OFFLINE_RESULTS_GROUP", "PackageKit Offline Update Results"),
